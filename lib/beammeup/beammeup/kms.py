...
def encode_dataflow_parameter(
    ...
    """From a given parameter part (username, password, connectionUrl) return the encoded string

    Args:
        parameter (str): The parameter part (username, password, connectionUrl)

    Returns:
        str: The string to paste into DataFlow template
    """
    ...
    return base64_encrypted_parameter
